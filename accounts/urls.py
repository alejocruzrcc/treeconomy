...
urlpatterns = [
    ...
    path('companies/create', login_required(views.create_company), name="create_company"),
    path('companies/editar/<str:pk>', login_required(views.edit_company), name='edit_company'),
